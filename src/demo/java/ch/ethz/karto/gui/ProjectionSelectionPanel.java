...
public class ProjectionSelectionPanel extends javax.swing.JPanel {
    ...
    public ProjectionSelectionPanel() {
        ...
        final Collection<String> projectionNames = ProjectionFactory.getOrderedProjectionNames();
        projectionComboBox.setModel(new DefaultComboBoxModel(new Vector<String>(projectionNames)));
    }

    private void project() {

        final boolean inverse = inverseCheckBox.isSelected();
        try {
            // find the selected name, create the corresponding projection.
            final String projName = (String) projectionComboBox.getSelectedItem();
            final Projection projection = ProjectionFactory.getNamedProjection(projName);
            ...
            if (projection != null) {
                ...
                final LineProjector projector = new LineProjector();
     ...
     *
     * @param lines
     *            The lines to project. Must be in geographic coordinates
     *            (degrees).
     */
    public void setLines(final ArrayList<MapLine> lines) {
     ...
     */
    private void updateProjectionInfo(final Projection projection) {
        if (projection == null) {
    ...
    private void initComponents() {
        ...
        final javax.swing.JLabel descriptionLeadLabel = new javax.swing.JLabel();
        descriptionLabel = new javax.swing.JLabel();
        final javax.swing.JLabel longitudeLeadLabel = new javax.swing.JLabel();
    ...
    private void lon0SliderStateChanged(final javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_lon0SliderStateChanged
    ...
    private void projectionComboBoxItemStateChanged(final java.awt.event.ItemEvent evt) {// GEN-FIRST:event_projectionComboBoxItemStateChanged
        if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
            project();
        }
    }// GEN-LAST:event_projectionComboBoxItemStateChanged

    private void inverseCheckBoxActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_inverseCheckBoxActionPerformed
        project();
    }// GEN-LAST:event_inverseCheckBoxActionPerformed

    private void previousProjectionButtonActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_previousProjectionButtonActionPerformed
        final int id = projectionComboBox.getSelectedIndex() - 1;
        if (id >= 0) {
    ...
    private void nextProjectionButtonActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_nextProjectionButtonActionPerformed
        final int id = projectionComboBox.getSelectedIndex() + 1;
    ...
    private javax.swing.JComboBox<DefaultComboBoxModel<?>> projectionComboBox;
